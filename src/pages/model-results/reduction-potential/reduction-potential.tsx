...
import BoxPlotChart from "components/charts/box-plot/box-blot";
import { FC } from "react";
import { ReductionPotentialProps } from "./reduction-potential.types";

export const ReductionPotential: FC<ReductionPotentialProps> = ({ options, isLoadingBuildings, setBuilding, data }) => (
